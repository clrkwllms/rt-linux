...
%define rttag rt30
%define rttag_minor_rev 2
%if 0%{?rttag_minor_rev}
%define rttag_minor .%{rttag_minor_rev}
%endif
...
%define rpmversion 2.6.%{base_sublevel}%{?stablerev}%{?rttag_minor}
...
### 2.6.33.7-rt29-mrg51
Patch76: bz637043-Avoid-pgoff-overflow-in-remap_file_pages.patch
Patch77: bz672405_CVE-2011-0521-media-v3-media-av7110-check-for-negative-array-offse.patch
Patch78: bz667030_CVE-2010-4526-sctp-Fix-a-race-between-ICMP-protocol-unreachable.patch
Patch79: bz672423_CVE-2010-4656-usb-iowarrior-don-t-trust-report_size.patch
Patch80: bz652509_CVE-2010-4165-tcp-Increase-TCP_MAXSEG-socket-opt-min.patch
Patch81: bz656763_CVE-2010-4249-lim-total-scm-lower.patch
Patch82: bz672436_CVE-2010-4655-net-clear-heap-allocations-for-privileged-ethtool.patch
Patch83: bz668372_CVE-2010-4649-IB-uverbs-Handle-large-num-of-entries-in-poll-CQ.patch
Patch84: bz667910_CVE-2010-4648-orinoco-fix-TKIP-countermeasure-behaviour.patch
Patch85: bz662195_CVE-2010-4346-special_mapping-skips-security_file_mmap.patch
# Patch86: bz677269_CVE-2011-0711-xfs-prevent-leaking-uninitialized-stack-mem.patch
Patch87: bz655661-CVE-2010-4242_bluetooth-Fix-missing-NULL.patch
Patch88: bz656269-CVE-2010-4248-posix-cpu-timers-workaround.patch
Patch89: bz663543_CVE-2010-4347-ACPI-debugfs-custom_method-op.patch
Patch90: bz664559_CVE-2010-4565-CAN-use-inode-instead.patch

### 2.6.33.7-rt29-mrg52
Patch91: bz656833_CVE-2010-4250-notify-stop-kernel-mem-leak-on-file-creat.patch
Patch92: bz636388_CVE-2010-3477-net-sched-fix-kernel-leak-in-act_police.patch
Patch93: bz652532_CVE-2010-4162-dont-overflow-pg-count-when-mapping-c.patch
Patch94: bz652960_CVE-2010-4163-CVE-2010-4668-block-chck-length-of-iov-entries-in-blk.patch
Patch95: bz659574_CVE-2010-4258-do_exit-check-is-run-with-get_fs-USER_DS.patch
...
ApplyPatch bz672405_CVE-2011-0521-media-v3-media-av7110-check-for-negative-array-offse.patch
# ApplyPatch bz667030_CVE-2010-4526-sctp-Fix-a-race-between-ICMP-protocol-unreachable.patch
ApplyPatch bz672423_CVE-2010-4656-usb-iowarrior-don-t-trust-report_size.patch
ApplyPatch bz652509_CVE-2010-4165-tcp-Increase-TCP_MAXSEG-socket-opt-min.patch
ApplyPatch bz656763_CVE-2010-4249-lim-total-scm-lower.patch
ApplyPatch bz672436_CVE-2010-4655-net-clear-heap-allocations-for-privileged-ethtool.patch
ApplyPatch bz668372_CVE-2010-4649-IB-uverbs-Handle-large-num-of-entries-in-poll-CQ.patch
ApplyPatch bz667910_CVE-2010-4648-orinoco-fix-TKIP-countermeasure-behaviour.patch
ApplyPatch bz662195_CVE-2010-4346-special_mapping-skips-security_file_mmap.patch
# ApplyPatch bz677269_CVE-2011-0711-xfs-prevent-leaking-uninitialized-stack-mem.patch
ApplyPatch bz655661-CVE-2010-4242_bluetooth-Fix-missing-NULL.patch
ApplyPatch bz656269-CVE-2010-4248-posix-cpu-timers-workaround.patch
...
ApplyPatch bz652532_CVE-2010-4162-dont-overflow-pg-count-when-mapping-c.patch
ApplyPatch bz652960_CVE-2010-4163-CVE-2010-4668-block-chck-length-of-iov-entries-in-blk.patch
ApplyPatch bz659574_CVE-2010-4258-do_exit-check-is-run-with-get_fs-USER_DS.patch
...
perl -p -i -e "s/^EXTRAVERSION.*/EXTRAVERSION = %{?stablerev}%{?rttag_minor}-%{pkg_release}$Flavour/" Makefile
