...
# Dropped bz448574-increase-max-stack-trace-entries.patch
...
### 2.6.31.4-rt14-mrg26
# PATCH63: bz529365-preempt_disable_rt-should-be-paired-with-preempt_rt.patch

### 2.6.31.4-rt14-mrg27
# PATCH64: bz529832-futex-Detect-mismatched-requeue-targets.patch
# PATCH65: bz529839-futex-comment-fixups.patch
# PATCH66: bz529855-futex-Move-drop_futex_key_refs-out-of-spinlock.patch
# PATCH67: bz529856-futex-Check-for-NULL-keys-in-match_futex.patch
# PATCH68: bz527658-Sched_load_balance.patch
# PATCH69: Updates-from-Jon-Masters-for-hwlat_detector.c.patch

### 2.6.31.4-rt14-mrg28
# PATCH70: bz531589-net-Make-setsockopt-optlen-be-unsigned.patch
# PATCH71: bz531595-futex-Fix-spurious-wakeup-for-requeue_pi-really.patch
# PATCH72: bz531611-netlink-fix-typo-in-initialization.patch
# PATCH73: bz531630-drm-r128-Add-test-for-initialisation-to-all-ioctls.patch
# PATCH74: bz531633-AF_UNIX-Fix-deadlock-on-connecting-to-shutdown-sock.patch
# PATCH75: bz531656-fs-pipe.c-null-pointer-dereference.patch
# PATCH76: bz531665-KEYS-get_instantiation_keyring-should-inc-the-key.patch
...
### 2.6.33-rt7-mrg6
# Patch25: 0001-lockbreak-in-load-balancer-for-RT.patch
...
### 2.6.33.1-rt11-mrg10
Patch77: Fix-CONFIG_STACK_TRACER-warning.patch
Patch78: x86-32-clean-up-rwsem-inline-asm-statements.patch
Patch79: x86-clean-up-rwsem-type-system.patch
Patch80: x86-64-rwsem-64-bit-xadd-rwsem-implementation.patch
Patch81: x86-Fix-breakage-of-UML-from-the-changes-in-the-rwse.patch
Patch82: x86-64-support-native-xadd-rwsem-implementation.patch
Patch83: x86-64-rwsem-Avoid-store-forwarding-hazard-in-__down.patch
Patch84: sched-sched_getaffinity-Allow-less-than-NR_CPUS-leng.patch
...
### 2.6.31.4-rt14-mrg26
# ApplyPatch bz529365-preempt_disable_rt-should-be-paired-with-preempt_rt.patch

### 2.6.31.4-rt14-mrg27
# ApplyPatch bz529832-futex-Detect-mismatched-requeue-targets.patch
# ApplyPatch bz529839-futex-comment-fixups.patch
# ApplyPatch bz529855-futex-Move-drop_futex_key_refs-out-of-spinlock.patch
# ApplyPatch bz529856-futex-Check-for-NULL-keys-in-match_futex.patch
# ApplyPatch bz527658-Sched_load_balance.patch
# ApplyPatch Updates-from-Jon-Masters-for-hwlat_detector.c.patch

### 2.6.31.4-rt14-mrg28
# ApplyPatch bz531589-net-Make-setsockopt-optlen-be-unsigned.patch
# ApplyPatch bz531595-futex-Fix-spurious-wakeup-for-requeue_pi-really.patch
# ApplyPatch bz531611-netlink-fix-typo-in-initialization.patch
# ApplyPatch bz531630-drm-r128-Add-test-for-initialisation-to-all-ioctls.patch
# ApplyPatch bz531633-AF_UNIX-Fix-deadlock-on-connecting-to-shutdown-sock.patch
# ApplyPatch bz531656-fs-pipe.c-null-pointer-dereference.patch
# ApplyPatch bz531665-KEYS-get_instantiation_keyring-should-inc-the-key.patch
...
### 2.6.33-rt7-mrg6
# ApplyPatch 0001-lockbreak-in-load-balancer-for-RT.patch
...
### 2.6.33.1-rt11-mrg10
ApplyPatch Fix-CONFIG_STACK_TRACER-warning.patch
ApplyPatch x86-32-clean-up-rwsem-inline-asm-statements.patch
ApplyPatch x86-clean-up-rwsem-type-system.patch
ApplyPatch x86-64-rwsem-64-bit-xadd-rwsem-implementation.patch
ApplyPatch x86-Fix-breakage-of-UML-from-the-changes-in-the-rwse.patch
ApplyPatch x86-64-support-native-xadd-rwsem-implementation.patch
ApplyPatch x86-64-rwsem-Avoid-store-forwarding-hazard-in-__down.patch
ApplyPatch sched-sched_getaffinity-Allow-less-than-NR_CPUS-leng.patch
...
* Tue Nov 10 2009 John Kacur <jkacur@redhat.com> - 2.6.31.6-rt19-mrg31
- Rebased to 2.6.31.6-rt19-mrg31
- Dropped bz465745-rtc-fix_kernel_panic_on_second_use_of_SIGIO_nofitication
- Above is made obsolete by 233e70f4228e78eb2f80dc6650f65d3ae3dbf17c
- Dropped bz529365-preempt_disable_rt-should-be-paired-with-preempt_rt.patch
- Above was picked-up as 1920d618c37ee53bb424a32f26076af2fa5b2a8b
- Dropped bz529832-futex-Detect-mismatched-requeue-targets.patch
- Above is e814515d47b9e15ebaa08bab0559d189e8ec90eb in -rt
- Above is 84bc4af59081ee974dd80210e694ab59ebe51ce8 upstream
- Dropped bz529839-futex-comment-fixups.patch
- Above is eb78fc3986049d977160b5b1624780d3e56f1d9b in -rt
- Dropped bz529855-futex-Move-drop_futex_key_refs-out-of-spinlock.patch
- Above is b9e40b501ba54f87044e5d95837d7f868e615fd0 in -rt
- Dropped bz529856-futex-Check-for-NULL-keys-in-match_futex.patch
- Above is 29b33bb77c20f83699cf47345bdeff7f0e0d20e4 in -rt
- Dropped bz527658-Sched_load_balance.patch
- Above is dac3518c37da9a68a60493b6c30e8713551b8ad1 in -rt
- Dropped Updates-from-Jon-Masters-for-hwlat_detector.c.patch
- Above is d9a4a1d04d0b5ba138a6a5b25013187d4614de4d in -rt
- Dropped bz531595-futex-Fix-spurious-wakeup-for-requeue_pi-really.patch
- Above is 43746940a0067656b612490e921ee8e782f12e30 in -rt
- Dropped bz531611-netlink-fix-typo-in-initialization.patch
- Above is 55443288c3721826ffe53521bb194cf5916ef9fb in -rt
- Dropped bz531630-drm-r128-Add-test-for-initialisation-to-all-ioctls.patch
- Above is e8b444f5280c41a0898de7c90a3a0d00a9103eda in -rt
- Dropped bz531633-AF_UNIX-Fix-deadlock-on-connecting-to-shutdown-sock.patch
- Above is f846ed7a8e32b6358ba968f8a0d9e428d9d36699 in -rt
- Dropped bz531656-fs-pipe.c-null-pointer-dereference.patch
- Above is 070609e1962b9089c357a7f4ec69a5ef76226203
- Dropped bz531665-KEYS-get_instantiation_keyring-should-inc-the-key.patch
- Above is 83001da0b6afe2fed8806ee23fe0ae7f9d435776
