...
%define patch_version 2.6.%{base_sublevel}%{?stablerev}
...
%if 0%{?stable_update}
Source1: patch-%{patch_version}.bz2
%endif
...
### 2.6.33.7-rt29-mrg39
Patch22: bz633142-drivers-net-usb-hso.c-prevent-reading-uninitialized-.patch
Patch23: bz633147-drivers-net-eql.c-prevent-reading-uninitialized-stac.patch
Patch24: bz633151-drivers-net-cxgb3-cxgb3_main.c-prevent-reading-unini.patch

### 2.6.33.7-rt29-mrg45
Patch25: bz607854-x86-don-t-send-SIGBUS-for-kernel-page-faults.patch

### 2.6.33.7-rt29-mrg46
Patch26: bz647434-perf-Mark-software-events-as-irqsafe.patch 

### 2.6.33.7-rt29-mrg47
Patch27: bz648696-CVE-2010-4074-USB-serialmos-prevent-reading-uninitialized-stack-memory.patch
Patch28: bz648699-CVE-2010-4075-tty-Make-tiocgicount-a-handler.patch
Patch29: bz648704-CVE-2010-4077-tty-icount-changeover-for-other-main-devices.patch
Patch30: bz637689-CVE-2010-2962-drmi915-Sanity-check-preadpwrite.patch
Patch31: bz649894-CVE-2010-3876-net-packet-fix-information-leak-to-userland.patch
Patch32: bz651265-CVE-2010-3880-inet_diag-Make-sure-we-actually-run-the-same-bytecode-we-audited..patch
Patch33: bz651699-CVE-2010-4158-filter-make-sure-filters-dont-read-uninitialized-memory.patch

### 2.6.33.7-rt29-mrg48
Patch34: bz660306-x86-Improve-TSC-calibration-using-a-delayed-workqueu.patch

### 2.6.33.7-rt29-mrg50
Patch35: bz465837-rtc-compat-rhel5.patch-ported-to-V2.patch

### 2.6.33.7-rt29-mrg51
Patch36: bz637043-Avoid-pgoff-overflow-in-remap_file_pages.patch
Patch37: bz656763_CVE-2010-4249-lim-total-scm-lower.patch
Patch38: bz663543_CVE-2010-4347-ACPI-debugfs-custom_method-op.patch
Patch39: bz664559_CVE-2010-4565-CAN-use-inode-instead.patch

### 2.6.33.7-rt29-mrg52
Patch40: bz656833_CVE-2010-4250-notify-stop-kernel-mem-leak-on-file-creat.patch
Patch41: bz636388_CVE-2010-3477-net-sched-fix-kernel-leak-in-act_police.patch

### 2.6.33.9-rt31-mrg59
Patch42: bz679308-video-sn9c102-world-wirtable-sysfs-files.patch
Patch43: bz679308-scsi-aic94xx-world-writable-sysfs-update_bios-file.patch
Patch44: bz673145-0001-Author-Jerome-Marchand-jmarchan-redhat.com.patch
Patch45: bz673145-0002-block-fix-accounting-bug-on-cross-partition-merges.patch
Patch46: bz673145-0003-block-add-internal-hd-part-table-references.patch

### 2.6.33.9-rt31-mrg60
Patch47: bz677269_CVE-2011-0711-xfs-prevent-leaking-uninitialized-stack-mem.patch
#Patch48: bz680003_CVE-2011-1016-drm-radeon-kms-check-AA-resolve-registers-on-r300.patch
#Patch49: bz680003_CVE-2011-1016-drm-radeon-fix-regression-with-AA-resolve-checking.patch
Patch50: bz692665-bnx2x-Fix-PHY-locking-problem.patch
Patch51: bz681309-Bluetooth-sco-fix-info-leak-to-userspace.patch
Patch52: bz681317-Bluetooth-bnep-fix-buffer-overflow.patch
Patch53: bz681324-segoon-openwall.com.patch

### 2.6.33.9-rt31-mrg61
Patch54: bz688026_CVE-2011-1163-Fix-corrupted-OSF-partition-table-parsing.patch
Patch55: bz689326-CVE-2011-1170-netfilter-arp_tables-fix-infoleak.patch
Patch56: bz689335-CVE-2011-1171-netfilter-ip_tables-fix-infoleak.patch
Patch57: bz689343-netfilter-ipt_CLUSTERIP-fix-buffer-overflow.patch
Patch58: bz689345_CVE-2011-1172-ipv6-netfilter-ip6_tables-fix-infoleak.patch

### 2.6.33.9-rt31-mrg62
Patch59: bz680964-mlx4-make-size-of-mcg-entry-module-param.patch

### 2.6.33.9-rt31-mrg63
Patch60: bz695829-watchdog-iTCO_wdt-Cleanup-warning-messages.patch
...
### 2.6.33.7-rt29-mrg51
ApplyPatch bz637043-Avoid-pgoff-overflow-in-remap_file_pages.patch
ApplyPatch bz656763_CVE-2010-4249-lim-total-scm-lower.patch
ApplyPatch bz663543_CVE-2010-4347-ACPI-debugfs-custom_method-op.patch
ApplyPatch bz664559_CVE-2010-4565-CAN-use-inode-instead.patch

### 2.6.33.7-rt29-mrg52
ApplyPatch bz656833_CVE-2010-4250-notify-stop-kernel-mem-leak-on-file-creat.patch
ApplyPatch bz636388_CVE-2010-3477-net-sched-fix-kernel-leak-in-act_police.patch

### 2.6.33.9-rt31-mrg59
ApplyPatch bz679308-video-sn9c102-world-wirtable-sysfs-files.patch
ApplyPatch bz679308-scsi-aic94xx-world-writable-sysfs-update_bios-file.patch
ApplyPatch bz673145-0001-Author-Jerome-Marchand-jmarchan-redhat.com.patch
ApplyPatch bz673145-0002-block-fix-accounting-bug-on-cross-partition-merges.patch
ApplyPatch bz673145-0003-block-add-internal-hd-part-table-references.patch

### 2.6.33.9-rt31-mrg60
ApplyPatch bz677269_CVE-2011-0711-xfs-prevent-leaking-uninitialized-stack-mem.patch
#ApplyPatch bz680003_CVE-2011-1016-drm-radeon-kms-check-AA-resolve-registers-on-r300.patch
#ApplyPatch bz680003_CVE-2011-1016-drm-radeon-fix-regression-with-AA-resolve-checking.patch
ApplyPatch bz692665-bnx2x-Fix-PHY-locking-problem.patch
ApplyPatch bz681309-Bluetooth-sco-fix-info-leak-to-userspace.patch
ApplyPatch bz681317-Bluetooth-bnep-fix-buffer-overflow.patch
ApplyPatch bz681324-segoon-openwall.com.patch

### 2.6.33.9-rt31-mrg61
ApplyPatch bz688026_CVE-2011-1163-Fix-corrupted-OSF-partition-table-parsing.patch
ApplyPatch bz689326-CVE-2011-1170-netfilter-arp_tables-fix-infoleak.patch
ApplyPatch bz689335-CVE-2011-1171-netfilter-ip_tables-fix-infoleak.patch
ApplyPatch bz689343-netfilter-ipt_CLUSTERIP-fix-buffer-overflow.patch
ApplyPatch bz689345_CVE-2011-1172-ipv6-netfilter-ip6_tables-fix-infoleak.patch

### 2.6.33.9-rt31-mrg62
ApplyPatch bz680964-mlx4-make-size-of-mcg-entry-module-param.patch

### 2.6.33.9-rt31-mrg63
ApplyPatch bz695829-watchdog-iTCO_wdt-Cleanup-warning-messages.patch
...
%if %{buildfirmware}
	...
	for kvname in debug trace vanilla; do
		cp -a %{buildroot}/lib/firmware/%{version}-%{release} %{buildroot}/lib/firmware/%{version}-%{release}$kvname
	done
%endif
...
/lib/firmware/%{version}-%{release}debug
...
/lib/firmware/%{version}-%{release}vanilla
...
/lib/firmware/%{version}-%{release}trace
...
%changelog
* Wed May 4 2011 John Kacur <jkacur@redhat.com> - 2.6.33.9-rt31-mrg64
- specfile patch from Luis Claudio to fix firmware package problem for
  debug / trace kernels

* Thu Apr 28 2011 John Kacur <jkacur@redhat.com> - 2.6.33.9-rt31-mrg63
- Added bz695829-watchdog-iTCO_wdt-Cleanup-warning-messages.patch

* Wed Apr 20 2011 John Kacur <jkacur@redhat.com> - 2.6.33.9-rt31-mrg62
- Added bz680964-mlx4-make-size-of-mcg-entry-module-param.patch

* Tue Apr 19 2011 John Kacur <jkacur@redhat.com> - 2.6.33.9-rt31-mrg61
- Added bz688026_CVE-2011-1163-Fix-corrupted-OSF-partition-table-parsing.patch
- Added bz689326-CVE-2011-1170-netfilter-arp_tables-fix-infoleak.patch
- Added bz689335-CVE-2011-1171-netfilter-ip_tables-fix-infoleak.patch
- Added bz689343-netfilter-ipt_CLUSTERIP-fix-buffer-overflow.patch
- Added bz689345_CVE-2011-1172-ipv6-netfilter-ip6_tables-fix-infoleak.patch

* Thu Apr 14 2011 John Kacur <jkacur@redhat.com> - 2.6.33.9-rt31-mrg60
- Added bz677269_CVE-2011-0711-xfs-prevent-leaking-uninitialized-stack-mem.patch
- Added bz692665-bnx2x-Fix-PHY-locking-problem.patch
- Added bz681309-Bluetooth-sco-fix-info-leak-to-userspace.patch
- Added bz681317-Bluetooth-bnep-fix-buffer-overflow.patch
- Added bz681324-segoon-openwall.com.patch

* Fri Apr 8 2011 John Kacur <jkacur@redhat.com> - 2.6.33.9-rt31-mrg59
- Removed bz667030_CVE-2010-4526-sctp-Fix-a-race-between-ICMP-protocol-unreachable.patch - part of stable update 2.6.33.8
- Added bz679308-video-sn9c102-world-wirtable-sysfs-files.patch
- Added bz679308-scsi-aic94xx-world-writable-sysfs-update_bios-file.patch
- Added bz673145-0001-Author-Jerome-Marchand-jmarchan-redhat.com.patch
- Added bz673145-0002-block-fix-accounting-bug-on-cross-partition-merges.patch
- Added bz673145-0003-block-add-internal-hd-part-table-references.patch

* Wed Apr 6 2011 John Kacur <jkacur@redhat.com> - 2.6.33.9-rt31-mrg57
- The following were removed because they are part of the stable updates
- Removed bz629445-aio-check-for-multiplication-overflow-in-do_io_submi.patch
- Removed bz638480-ALSA-prevent-heap-corruption-in-snd_ctl_new.patch
- Removed bz648685-CVE-2010-4072-ipc-shm-fix-information-leak-to-userland.patch
- Removed bz648691-CVE-2010-4073-ipc-initialize-structure-memory-to-zero-for-compat-functions.patch
- Removed bz648831-CVE-2010-4079-V4LDVB-ivtvfb-prevent-reading-uninitialized-stack-memory.patch
- Removed bz648707-CVE-2010-4080-ALSA-soundpcirme9652-prevent-reading-uninitialized-stack-memory.patch
- Removed bz648717-CVE-2010-4082-driversvideoviaioctl.c-prevent-reading-uninitialized-stack-memory.patch
- Removed bz648720-CVE-2010-4083-sys_semctl-fix-kernel-stack-leakage.patch
- Removed bz651172-CVE-2010-4157-SCSI-gdth-integer-overflow-in-ioctl.patch
- Removed bz642469-CVE-2010-2963-v4l1-fix-32-bit-compat-microcode-loading-translation.patch
- Removed bz651674-CVE-2010-4169-perf_events-Fix-perf_counter_mmap-hook-in-mprotect.patch
- Removed bz637680-CVE-2010-3432-sctp-Do-not-reset-the-packet-during-sctp_packet_config..patch
- Removed bz640460-CVE-2010-3705-sctp-Fix-out-of-bounds-reading-in-sctp_asoc_get_hmac.patch
- Removed bz645223-CVE-2010-3858-setup_arg_pages-diagnose-excessive-argument-size.patch
- Removed bz646726-CVE-2010-3861-net-clear-heap-allocation-for-ETHTOOL_GRXCLSRLALL.patch
- Removed bz651845-CVE-2010-3874-can-bcm-fix-minor-heap-overflow.patch
- Removed bz651893-CVE-2010-4160-net-Truncate-recvfrom-and-sendto-length-to-INT_MAX.patch
- Removed bz672405_CVE-2011-0521-media-v3-media-av7110-check-for-negative-array-offse.patch
- Removed bz672423_CVE-2010-4656-usb-iowarrior-don-t-trust-report_size.patch
- Removed bz652509_CVE-2010-4165-tcp-Increase-TCP_MAXSEG-socket-opt-min.patch
- Removed bz672436_CVE-2010-4655-net-clear-heap-allocations-for-privileged-ethtool.patch
- Removed bz668372_CVE-2010-4649-IB-uverbs-Handle-large-num-of-entries-in-poll-CQ.patch
- Removed bz667910_CVE-2010-4648-orinoco-fix-TKIP-countermeasure-behaviour.patch
- Removed bz662195_CVE-2010-4346-special_mapping-skips-security_file_mmap.patch
- Removed bz655661-CVE-2010-4242_bluetooth-Fix-missing-NULL.patch
- Removed bz656269-CVE-2010-4248-posix-cpu-timers-workaround.patch
- Removed bz652532_CVE-2010-4162-dont-overflow-pg-count-when-mapping-c.patch
- Removed bz652960_CVE-2010-4163-CVE-2010-4668-block-chck-length-of-iov-entries-in-blk.patch
- Removed bz659574_CVE-2010-4258-do_exit-check-is-run-with-get_fs-USER_DS.patch

* Mon Mar 14 2011 John Kacur <jkacur@redhat.com> - 2.6.33.7.2-rt30-mrg56
- Incorporated patch-2.6.33.7.2-rt30.bz2
- The following SHA1s refer to commits in v2.6.33.7.2-rt30
- Removed bz625713-Fix-an-Oops-in-the-NFSv4-atomic-open-code.patch
- 	88df8860c784d4d4ba054701c565333fb6317e52
- Removed bz625701-can-add-limit-for-nframes-and-clean-up-signed-unsign.patch
- 	300bc74d197bfbfc7e843b2529e31a93043dfe80
- Removed bz621436-drm-stop-information-leak-of-old-kernel-stack.patch
- Removed bz621436-drm-block-userspace-under-allocating-buffer-and-havi.patch
- The above two patches are equivalent to
	bf18be070d1b8d87f6ba3c01686e1c8fc3ef0aca
- Removed bz627807-KEYS-Fix-RCU-no-lock-warning-in-keyctl_session_to_pa.patch
-	300f0c0dc280e9ee7a259651d4eb6d3e7ba3488f
- Removed bz627807-KEYS-Fix-bug-in-keyctl_session_to_parent-if-parent-h.patch
-	4d4ea8b53f6dae1fb354b8536a0ead210d6ea6d4
- Removed bz632070-niu-Fix-kernel-buffer-overflow-for-ETHTOOL_GRXCLSRLA.patch
-	1389ed5d809bc8369fa9f9c7f930735397901d6b
- Removed bz631624-tracing-Do-not-allow-llseek-to-set_ftrace_filter.patch
-	dc7dde7adbc57b7461b4b1302c94fe31699f60e2
- Removed bz626316-act_nat-use-stack-variable.patch
-	cd92f998fd8a688dce9b9a7930f6bfbc30d2f918
- Removed bz626316-net-sched-fix-some-kernel-memory-leaks.patch
-	49aa1d9ed423c0d901b5e0c072f1b0269a17a572
- Removed bz628436-wireless-extensions-fix-kernel-heap-content-leak.patch
-	5741fe45da56e3a75eac22942d0fae123ae7d9a0
- Removed bz630553-ALSA-seq-oss-Fix-double-free-at-error-path-of-snd_se.patch
-	85b5abf5021d91c11185e25a542ce1f55b1a0f16
- Removed bz634450-x86-64-compat-Test-rax-for-the-syscall-number-not-ea.patch
-	b2104d5552a93f7efa58be388ad7c3d5faf747ca
- Removed bz634450-x86-64-compat-Retruncate-rax-after-ia32-syscall-entr.patch
-	3609ee783b603f811c3c1d9b2bba3a15dc8030cd
- Removed bz634460-compat-Make-compat_alloc_user_space-incorporate-the.patch
-	c2841fe895b29834edd7137478e2ba19a4a21ef1
- Removed bz607854-mm-make-stack-guard-page-logic-use-vm_prev-pointer.patch
-	3cf7bf56bb62dcb9d99b0060bac4648e2bf8cb16
- Removed bz607854-mm-fix-page-table-unmap-for-stack-guard-page-properl.patch
-	a487cf3a8203643d21d9c14823586e2c72eebaba
- Removed bz607854-mm-fix-missing-page-table-unmap-for-stack-guard-page.patch
-	27ed5f7263e8c301282298ef3d6c911455bba26a
- Removed bz607854-mm-keep-a-guard-page-below-a-grow-down-stack-segment.patch
-	ed313b5159c985cddcc9bc5d3468a7f470c41292
- Removed bz607854-mm-fix-up-some-user-visible-effects-of-the-stack-gua.patch
-	e276f93c1c8ba22adf058e219caaf3fd1e6cecf5
- Removed bz607854-mm-make-the-vma-list-be-doubly-linked.patch
-	498f7001734ff4fb0ef5a494241c1048b1264c0a
- Removed bz607854-mm-make-the-mlock-stack-guard-page-checks-stricter.patch
-	901f364298f4e4a1c3334d291fb90967b25e61de

* Tue Mar 8 2011 John Kacur <jkacur@redhat.com> - 2.6.33.7-rt29-mrg55
- disabled bz667030_CVE-2010-4526-sctp-Fix-a-race-between-ICMP-protocol-unreachable.patch until we have a full solution

* Wed Mar 2 2011 John Kacur <jkacur@redhat.com> - 2.6.33.7-rt29-mrg54
- disabling bz677269_CVE-2011-0711-xfs-prevent-leaking-uninitialized-stack-mem.patch until an upstream solution is available

* Tue Mar 1 2011 John Kacur <jkacur@redhat.com> - 2.6.33.7-rt29-mrg53
- Replaced bz677269_CVE-2011-0711-xfs-prevent-leaking-uninitialized-stack-mem.patch

* Thu Feb 24 2011 John Kacur <jkacur@redhat.com> - 2.6.33.7-rt29-mrg52
- Added bz656833_CVE-2010-4250-notify-stop-kernel-mem-leak-on-file-creat.patch
- Added bz636388_CVE-2010-3477-net-sched-fix-kernel-leak-in-act_police.patch
- Added bz652532_CVE-2010-4162-dont-overflow-pg-count-when-mapping-c.patch
- Added bz652960_CVE-2010-4163-CVE-2010-4668-block-chck-length-of-iov-entries-in-blk.patch
- Added bz659574_CVE-2010-4258-do_exit-check-is-run-with-get_fs-USER_DS.patch

* Wed Feb 23 2011 John Kacur <jkacur@redhat.com> - 2.6.33.7-rt29-mrg51
- Added bz637043-Avoid-pgoff-overflow-in-remap_file_pages.patch
- Added bz672405_CVE-2011-0521-media-v3-media-av7110-check-for-negative-array-offse.patch
- Added bz667030_CVE-2010-4526-sctp-Fix-a-race-between-ICMP-protocol-unreachable.patch
- Added bz672423_CVE-2010-4656-usb-iowarrior-don-t-trust-report_size.patch
- Added bz652509_CVE-2010-4165-tcp-Increase-TCP_MAXSEG-socket-opt-min.patch
- Added bz656763_CVE-2010-4249-lim-total-scm-lower.patch
- Added bz672436_CVE-2010-4655-net-clear-heap-allocations-for-privileged-ethtool.patch
- Added bz668372_CVE-2010-4649-IB-uverbs-Handle-large-num-of-entries-in-poll-CQ.patch
- Added bz667910_CVE-2010-4648-orinoco-fix-TKIP-countermeasure-behaviour.patch
- Added bz662195_CVE-2010-4346-special_mapping-skips-security_file_mmap.patch
- Added bz677269_CVE-2011-0711-xfs-prevent-leaking-uninitialized-stack-mem.patch
- Added bz655661-CVE-2010-4242_bluetooth-Fix-missing-NULL.patch
- Added bz656269-CVE-2010-4248-posix-cpu-timers-workaround.patch
- Added bz663543_CVE-2010-4347-ACPI-debugfs-custom_method-op.patch
- Added bz664559_CVE-2010-4565-CAN-use-inode-instead.patch
